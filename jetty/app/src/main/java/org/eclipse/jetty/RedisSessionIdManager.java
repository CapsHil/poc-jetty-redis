...
public class RedisSessionIdManager extends AbstractSessionIdManager {
    ...
    public boolean idInUse(String id) {
        Jedis jedis = null;
        try {
            System.out.println("idInUser called");
            jedis = jedisPool.getResource();
            boolean exists = jedis.exists(id);
            return exists;
        } catch (Exception e) {
            System.out.println("exception while calling redis " + e);
        } finally {
            if (jedis != null) {
                jedis.close();
            }
    ...
    public void removeSession(HttpSession session) {
        ...
        System.out.println("removeSession was called");
    }
    ...
    public void invalidateAll(String sessionId) {
        // handled by session manager
        System.out.println("invalidateAll was called");
    }
